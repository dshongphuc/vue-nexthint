<template>
  <header class="">
      <div class="container px-6 mx-auto">
          ...
          <section class="flex items-center flex-1 mt-20">
              <div class="flex flex-col w-full ">
                  <h1 class="text-5xl font-extrabold text-center lg:text-7xl 2xl:text-8xl">
                      ...
                      <span class="text-transparent -ml-6 bg-gradient-to-tr bg-clip-text from-blue-500 via-pink-500 to-red-500 dark:from-sky-300 dark:via-pink-300 dark:to-red-500">
                        Hint
                      </span>
                  </h1>

                  <p class="max-w-3xl mx-auto mt-6 text-lg text-center text-gray-200 md:text-xl">
  ...
  <div class="absolute bottom-4 mx-auto left-0 right-0 text-center">
    Made with <span class="heart">❤</span> by
    <a href="https://dshongphuc.com/blog/" target="_blank" class="hover:underline">Phuc H.</a>
  </div>
 </template>
...
const suggestions = [
    ...
    "Rust", "Go", "Scala", "Elixir", "Dart", "Perl", "Haskell", "Clojure", "Lua", "Groovy",
    "Objective-C", "SQL", "MongoDB", "Firebase", "Docker", "Kubernetes", "Git", "GitHub", "GitLab", "Bitbucket",
    "Jenkins", "Travis CI", "CircleCI", "Azure DevOps", "AWS", "Google Cloud", "Azure", "React.js", "Vue.js", "Angular",
    "Svelte", "Ember.js", "Backbone.js", "jQuery", "Bootstrap", "Tailwind CSS", "SASS", "LESS", "Webpack", "Babel",
    "NPM", "Yarn", "Express.js", "Django", "Flask", "Laravel", "Spring", ".NET", "ASP.NET", "Ruby on Rails",
    "GraphQL", "REST API", "SOAP", "JSON", "XML", "WebSockets", "HTML5", "CSS3", "AJAX", "WebRTC",
    "Ethereum", "Solidity", "Web3.js", "Blockchain", "Bitcoin", "Cryptography", "Machine Learning", "TensorFlow", "PyTorch", "Keras",
    "Scikit-learn", "Data Science", "Pandas", "NumPy", "Matplotlib", "Jupyter Notebook", "R programming", "MATLAB", "Apache Spark", "Hadoop",
    "Big Data", "Artificial Intelligence", "Computer Vision", "Natural Language Processing", "Deep Learning", "Neural Networks", "Convolutional Neural Networks", "Reinforcement Learning", "Generative Adversarial Networks", "OpenCV"
]
</script>
